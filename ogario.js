function init(window, ogario, JQuery) {
    ...
    const application = {
        ...
        setMenu() {
            ...
            JQuery(`.left-container`).append(`<div id="quick-menu" class="agario-panel agario-side-panel"><a href="https://ogario.ovh/skins/" class="quick-more-skins ogicon-grin" target="_blank" data-toggle="tab-tooltip" data-placement="left" title="` + textLanguage.skins + `"></a><a href="https://www.youtube.com/redaxee?sub_confirmation=1" class="quick-yt ogicon-youtube2" target="_blank" data-toggle="tab-tooltip" data-placement="left" title="Team OGARio"></a></div>`);
            if (!this.protocolMode) {
    ...
    function setGUI(){
        document.getElementById('quick-menu').innerHTML = `
            ...
            <h5 id="botsAuthor">
                Developed by <a href="https://www.youtube.com/redaxee?sub_confirmation=1" target="_blank">[EG]ExhaleGlory</a>
            </h5>
